...
def pso(func, bounds, swarm_size=10, inertia=0.5, pa=0.8, ga=0.9, 
    ...
    for i in range(num_iters):
        ...
        if verbose and i % 10 == 0: print('iter# {}:'.format(i), end='')
...
## Rosenbrock func
history = pso(rosenbrock_fun, bounds=[[-2,2],[-2,2]], swarm_size=30, inertia=0.7, num_iters=100, verbose=1, func_name='Rosenbrock Function')
print('global best:',history['global_best_fitness'][-1], ', global best position:', history['global_best'][-1])
